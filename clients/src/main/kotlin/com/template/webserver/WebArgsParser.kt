...
class ArgsParser{
    ...
    fun parse(vararg args: String): com.template.webserver.CmdLineOptions {
...
data class CmdLineOptions(val baseDirectory: Path,
    ...
    private fun loadConfig(baseDirectory: Path,
        ...
        val finalConfig = overrideConfig
                ...
                .resolve()
        val log = loggerFor<net.corda.webserver.CmdLineOptions>() // I guess this is lazy so it happens after logging init.
